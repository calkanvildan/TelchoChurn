...
df=pd.read_csv(r"C:\Users\VFMARS\Desktop\TELCHO\dataset\Telco-Customer-Churn.csv")
df.head()
df.shape
df.info()
# TotalCharges : Müşteriden tahsil edilen toplam tutar ama object tipinde geldiği için numerice çevirdik.
